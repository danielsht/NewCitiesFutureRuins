...
//    noStroke();  
  ...
  void calculate() {
    color colorA = color(140, 60, 60);
    color colorB = color(140, 120, 120);
    switch(this.state) {
    case 0: // city
    ...
    case 1: // lowest terrain
      this.c = color(112, 53, 46, 175);
      this.elev = 5;
      break;
    case 2: // medium-low terrain
      this.c = color(211, 82, 56, 175);
      this.elev = 4;
      break;
    case 3: // medium-hi terrain
      this.c = color(248, 152, 84, 175);
      this.elev = 2;
      break;
    case 4: // hi terrain
      this.c = color(109, 97, 54, 175);
      this.elev = 1;
      break;
    case 5: // river
